...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<Product> sortByName() throws ServiceException, SQLException {
		// TODO Auto-generated method stub
		return (List<Product>) productDao.getAll().stream().sorted(Comparator.comparing(Product::getName));
	}

	@Override
	public List<Product> sortByBrand() throws ServiceException, SQLException {
		// TODO Auto-generated method stub
		return (List<Product>) productDao.getAll().stream().sorted(Comparator.comparing(Product::getBrand));
	}

	@Override
	public List<Product> sortByPrice() throws ServiceException, SQLException {
		// TODO Auto-generated method stub
		return (List<Product>) productDao.getAll().stream().sorted(Comparator.comparing(Product::getPrice));
	}

	@Override
	public List<Product> sortByPriceDesc() throws ServiceException, SQLException {
		// TODO Auto-generated method stub
